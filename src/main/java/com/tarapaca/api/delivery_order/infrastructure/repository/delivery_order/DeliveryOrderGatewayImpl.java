...
import com.tarapaca.api.delivery_order.domain.model.OrderStatusChangeObserver;
...
import com.tarapaca.api.generics.infrastructure.repository.GenericProduction.GenericProductionGatewayImpl;
...
public class DeliveryOrderGatewayImpl extends
    ...
    public DeliveryOrder update(DeliveryOrder order) {
        ...
        prepareUpdatedDeliveryOrder(order, currentUser);
    ...
    private void prepareUpdatedDeliveryOrder(DeliveryOrder order, UserBasic currentUser) {
