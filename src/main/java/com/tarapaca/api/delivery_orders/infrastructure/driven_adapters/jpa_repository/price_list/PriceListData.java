...
@FilterDef(name = "deletedPriceListFilter", parameters = @ParamDef(name = "isDeleted", type = Boolean.class))
@Filter(name = "deletedPriceListFilter", condition = "is_deleted = :isDeleted")
public class PriceListData extends GenericNamedData {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PriceListData that)) return false;
